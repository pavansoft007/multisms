...
try {
    ...
    <body data-role-id="<?php echo $role_id; ?>">
        ...
        <?php if ($role_id == 1 || $role_id == 2): // Admin or Superadmin ?>
        <div style="background-color: #e9f7fe; border-left: 4px solid #0091cd; padding: 10px 15px; margin: 10px;">
            <h3 style="margin-top: 0; font-size: 16px; color: #0091cd;">Admin Settings</h3>
            <p style="margin: 5px 0;">Configure mobile cards for different roles:</p>
            <a href="mobile_cards_settings.php" class="btn btn-primary" style="display: inline-block; background-color: #0091cd; color: white; padding: 8px 15px; text-decoration: none; border-radius: 4px; margin-top: 5px;">
                <i class="material-icons" style="font-size: 16px; vertical-align: middle;">settings</i> 
                Mobile Cards Settings
            </a>
        </div>
        <?php endif; ?>
        ...
        <div class="bottom-nav">
            <a href="mobilemain.php" class="active">
