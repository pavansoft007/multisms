			...
			foreach ($menu_items as $item) {
				switch ($item) {
					...
					case 'homework':
						...
						$homework_url = (is_student_loggedin() || is_parent_loggedin()) ? 'userrole/homework' : 'homework';
						?>
						<li>
							<a href="<?php echo base_url($homework_url);?>">
					...
					case 'fees':
						...
						$fees_url = (is_student_loggedin() || is_parent_loggedin()) ? 'userrole/invoice' : 'fees/invoice_list';
						?>
						<li>
							<a href="<?php echo base_url($fees_url);?>">
