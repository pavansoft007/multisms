...
try {
    ...
    <head>
        ...
        <title>Mobile Dashboard (Direct)</title>
    ...
    <body data-role-id="<?php echo $role_id; ?>">
        <div class="direct-banner">
            Direct Version | <a href="direct_tools.php">Tools</a> | <a href="direct_settings.php">Settings</a> | <a href="check_session.php">Session</a>
        </div>
        ...
        <div class="url-info">
            ...
            <p>You are viewing the direct implementation of the mobile main page.</p>
            <p>Current URL: <code><?php echo $_SERVER['REQUEST_URI']; ?></code></p>
            <p>Try these URLs:</p>
            <ul>
                <li><a href="mobilemain">mobilemain</a> (should redirect to index.php/mobilemain)</li>
                <li><a href="index.php/mobilemain?force_mobile=1">index.php/mobilemain?force_mobile=1</a> (original URL)</li>
                <li><a href="standalone_mobilemain.php">standalone_mobilemain.php</a> (standalone version)</li>
            </ul>
        </div>
        ...
        <div class="bottom-nav">
            <a href="mobilemain_direct.php" class="active">
